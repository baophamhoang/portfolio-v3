...
export function PortfolioShell({
  ...
  useEffect(() => {
    const onPop = () => {
      const hash = window.location.hash.slice(1);
      const panel = panelOrder.includes(hash as PanelId)
        ? (hash as PanelId)
        : 'home';
  ...
  return (
    <div className="h-[100dvh] overflow-hidden flex">
      ...
      <main
        className={`flex-1 lg:ml-[240px] relative overflow-hidden${shaking ? ' animate-shake' : ''}`}
      >
        <AnimatePresence mode="wait">
          {activePanel === 'home' && (
            <motion.div
              ...
              onWheel={handleWheel}
            >
              <div className="relative min-h-[100dvh] bg-[#F7F3EC] dark:bg-[#0E0D0C] scanlines pixel-grid warm-panel">
          ...
          {activePanel === 'work' && (
            <motion.div
              ...
              onWheel={handleWheel}
            >
              <div className="relative min-h-[100dvh] bg-[#F0EDE8] dark:bg-[#141210] scanlines pixel-grid warm-panel">
          ...
          {activePanel === 'projects' && (
            <motion.div
              ...
              onWheel={handleWheel}
            >
              <div className="relative min-h-[100dvh] bg-[#ECEBE6] dark:bg-[#131211] scanlines pixel-grid warm-panel">
          ...
          {activePanel === 'skills' && (
            <motion.div
              ...
              onWheel={handleWheel}
            >
              <div className="relative min-h-[100dvh] bg-[#FFFBEB] dark:bg-[#110F0E] scanlines pixel-grid warm-panel">
          ...
          {activePanel === 'contact' && (
            <motion.div
              ...
              onWheel={handleWheel}
            >
              <div className="relative min-h-[100dvh] bg-[#EDE8DF] dark:bg-[#1A1917] scanlines pixel-grid warm-panel">
