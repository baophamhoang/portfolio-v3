...
export function Skills({ skills, profile }: SkillsProps) {
  ...
  return (
    <section id="skills" className="relative min-h-full py-10 px-6">
      {/* Ambient amber glow */}
      <div className="absolute bottom-0 right-0 w-[700px] h-[700px] bg-amber-500/8 dark:bg-amber-500/20 lg:blur-3xl pointer-events-none rounded-full panel-glow-mobile" />
